 ...
 * 公共组件--loading对话框
 */
public class DataSubmit extends Dialog {
    ...
    public DataSubmit(Context context) {
        super(context, R.style.task_dialog);
        ctx = context;
    }

    public DataSubmit(Context context, OnCancelListener onCancelListener) {
        super(context, R.style.task_dialog);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTxtMsg = findViewById(R.id.submit_data);
    }
